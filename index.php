...
<head>
	...
	<style type="text/css">
		img.wp-smiley,img.emoji{display:inline!important;
		            ...
		            width:1em!important;margin:0 .07em!important;
		            vertical-align:-0.1em!important;
		            background:none!important;padding:0!important}
	</style>
	<style id='vp-controls-styles-105-inline-css' type='text/css'>
		.vp-id-105 .vp-filter__style-default .vp-filter__item{-webkit-box-flex:1}.vp-id-105 .vp-filter__style-default .vp-filter__item{flex:1}
	</style>
	<style id='vp-custom-css-105-inline-css' type='text/css'>
		.vp-id-105 article:not(:first-child) .nk-post-img img{height:136px}
	</style>
	<style id='vp-controls-styles-109-inline-css' type='text/css'>
		.vp-id-109 .vp-portfolio__items-style-squadforce-gallery .vp-portfolio__item-overlay{background-color:rgba(221,22,59,.95)}.vp-id-109 .vp-portfolio__items-style-squadforce-gallery .vp-portfolio__item-overlay{color:#fff}
	</style>
	<noscript></noscript>
	<style id='visual-portfolio-popup-fancybox-inline-css' type='text/css'>
		.vp-fancybox .fancybox-bg{background-color:#1e1e1e}
	</style>
	<link rel='stylesheet' id='woocommerce-smallscreen-css' href='assets/css/second.css?ver=4.0.1' type='text/css' media='only screen and (max-width: 768px)' />
	<style id='woocommerce-inline-inline-css' type='text/css'>
		.woocommerce form .form-row .required{visibility:visible}
	</style>
	<style id='ghostkit-blocks-content-custom-css-inline-css' type='text/css'>
		.ghostkit-custom-1ML7kj{margin-top:30px}.ghostkit-custom-1IOFOw{margin-bottom:35px;margin-top:2px}.ghostkit-custom-2pVI05{margin-top:30px!important;margin-bottom:30px!important}.ghostkit-custom-Z1caIr8{--gkt-icon-box--icon__font-size:62px;--gkt-icon-box--icon__color:#eee}.ghostkit-custom-Z1TdVt6{margin-left:15px;padding-top:6px}.ghostkit-custom-8lyq2{margin-left:15px}.ghostkit-custom-Z11HzSx{--gkt-icon-box--icon__font-size:62px;--gkt-icon-box--icon__color:#eee}.ghostkit-custom-Z2ivI4T{margin-left:15px;padding-top:6px}.ghostkit-custom-ZHh21i{margin-left:15px}.ghostkit-custom-ZN3lsw{--gkt-icon-box--icon__font-size:62px;--gkt-icon-box--icon__color:#eee}.ghostkit-custom-ZJPY1r{margin-left:15px;padding-top:6px}.ghostkit-custom-ZcFLQv{margin-left:15px}.ghostkit-grid .ghostkit-custom-Z2vCcNQ{--gkt-grid--column-sticky__offset:0}.ghostkit-custom-1H35Ox{margin-bottom:35px;margin-top:25px}.ghostkit-custom-3Nm3T{margin-bottom:35px;margin-top:25px}.ghostkit-custom-29FLbr{margin-bottom:30px;margin-top:50px}.ghostkit-custom-1N7EVA{margin-top:47px;margin-bottom:36px}.ghostkit-custom-7tbBF{margin-top:50px;margin-bottom:35px}.ghostkit-custom-YtvMm{--gkt-button__background-color:#2f3541;--gkt-button__border-radius:4px;--gkt-button-hover__background-color:#dd163b;--gkt-button-focus__background-color:#dd163b}.ghostkit-custom-Zbp2Jo{--gkt-button__background-color:#dd163b;--gkt-button__border-radius:4px;--gkt-button-hover__background-color:#eb3154;--gkt-button-hover__color:#fff;--gkt-button-focus__background-color:#eb3154;--gkt-button-focus__color:#fff}
	</style>
	<style id='ghostkit-global-custom-css-inline-css' type='text/css'>
		.col-lg-8 .nk-woocommerce-filtering,.ghostkit-col-8 .nk-woocommerce-filtering{display:none}
	</style>
	...
	<script type='text/javascript'>
		/* <![CDATA[ */ var LWA = {"ajaxurl":"https:\/\/wp.nkdev.info\/squadforce\/wp-admin\/admin-ajax.php"}; /* ]]> */
	</script>
	<script type='text/javascript' src='https://www.googletagmanager.com/gtag/js?id=UA-48958097-3' async></script>
	<script type='text/javascript'>
	...
	<script type='text/javascript'>
		/* <![CDATA[ */ var ghostkitWebfontList = {"google-fonts":{"Open Sans":{"widths":["400","400i","700","700i"],"category":"sans-serif","subsets":["cyrillic","greek","latin","greek-ext","vietnamese","latin-ext","cyrillic-ext"]},"Montserrat":{"widths":["700","700i"],"category":"sans-serif","subsets":["cyrillic","latin","vietnamese","latin-ext","cyrillic-ext"]}}}; /* ]]> */
	</script>
	<link rel='https://api.w.org/' href='https://wp.nkdev.info/squadforce/wp-json/' />
	<link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://wp.nkdev.info/squadforce/xmlrpc.php?rsd" />
	...
	<meta name="google-site-verification" content="LVPFRY2QDeZcKxPyMkqgv8KNgkUfixsP92D2oQTkIAg">
...
<body class="home page-template-default page page-id-12 theme-squadforce woocommerce-no-js">
			...
			<div class="container">
					...
					<ul class="nk-social-links">
						<li>
							<a class="nk-social-twitch" href="#" target="_self">
								<svg class="bsp-icon" width="24" height="24" aria-hidden="true" role="img" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
						...
						<li>
							<a class="nk-social-youtube" href="#" target="_self">
								<svg class="bsp-icon" width="24" height="24" aria-hidden="true" role="img" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
						...
						<li>
							<a class="nk-social-steam" href="#" target="_self">
								<svg class="bsp-icon" width="24" height="24" aria-hidden="true" role="img" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
						...
						<li>
							<a class="nk-social-discord" href="#" target="_self">
								<svg class="bsp-icon" width="24" height="24" aria-hidden="true" role="img" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
				...
				<div class="nk-contacts-right">
					<ul class="nk-contacts-icons">
						<li>
							<a href="#" data-toggle="modal" data-target="#modalSearch"> <span class="fa fa-search"></span>
							</a>
						</li>
						<li>
							<a href="#" data-toggle="modal" data-target="#modalLogin"> <span class="fas fa-sign-in-alt"></span>
							</a>
						</li>
						<li> <span class="nk-cart-toggle"> <span class="fa fa-shopping-cart"></span>  <span class="nk-badge squadforce-woocommerce-cart-count d-none">0</span> </span>
				...
				<div class="nk-nav-table">
					...
					<ul id="menu-main-menu" class="nk-nav nk-nav-right d-none d-lg-table-cell" data-nav-mobile="#nk-nav-mobile">
						...
						<!-- <li id="menu-item-1019" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children ghost_menu__item nk-drop-item ghost_menu__item--1019 menu-item-1019"><a href="#">Features</a>
							<ul class="dropdown sub-menu">
								...
								<li id="menu-item-1002" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children nk-drop-item ghost_menu__sub-menu__item ghost_menu__sub-menu--1__item ghost_menu__item--1002 menu-item-1002"><a href="https://wp.nkdev.info/squadforce/blocks/">Blocks</a>
									<ul class="dropdown sub-menu">
										<li id="menu-item-1009" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--2__item ghost_menu__item--1009 menu-item-1009"><a href="https://wp.nkdev.info/squadforce/blocks/icon-box/">Icon Box</a>
										</li>
										<li id="menu-item-1011" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--2__item ghost_menu__item--1011 menu-item-1011"><a href="https://wp.nkdev.info/squadforce/blocks/number-box/">Number Box</a>
										</li>
										<li id="menu-item-1003" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--2__item ghost_menu__item--1003 menu-item-1003"><a href="https://wp.nkdev.info/squadforce/blocks/accordion/">Accordion</a>
										</li>
										<li id="menu-item-1015" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--2__item ghost_menu__item--1015 menu-item-1015"><a href="https://wp.nkdev.info/squadforce/blocks/tabs/">Tabs</a>
										</li>
										<li id="menu-item-1039" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--2__item ghost_menu__item--1039 menu-item-1039"><a href="https://wp.nkdev.info/squadforce/blocks/button/">Button</a>
										</li>
										<li id="menu-item-1005" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--2__item ghost_menu__item--1005 menu-item-1005"><a href="https://wp.nkdev.info/squadforce/blocks/countdown/">Countdown</a>
										</li>
										<li id="menu-item-1008" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--2__item ghost_menu__item--1008 menu-item-1008"><a href="https://wp.nkdev.info/squadforce/blocks/grid/">Grid</a>
										</li>
										<li id="menu-item-1018" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--2__item ghost_menu__item--1018 menu-item-1018"><a href="https://wp.nkdev.info/squadforce/blocks/video/">Video</a>
										</li>
										<li id="menu-item-1004" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--2__item ghost_menu__item--1004 menu-item-1004"><a href="https://wp.nkdev.info/squadforce/blocks/alert/">Alert</a>
										</li>
										<li id="menu-item-1013" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--2__item ghost_menu__item--1013 menu-item-1013"><a href="https://wp.nkdev.info/squadforce/blocks/progress/">Progress</a>
										</li>
										<li id="menu-item-1014" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--2__item ghost_menu__item--1014 menu-item-1014"><a href="https://wp.nkdev.info/squadforce/blocks/tables/">Tables</a>
										</li>
										<li id="menu-item-1012" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--2__item ghost_menu__item--1012 menu-item-1012"><a href="https://wp.nkdev.info/squadforce/blocks/pricing-table/">Pricing Table</a>
										</li>
										<li id="menu-item-1016" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--2__item ghost_menu__item--1016 menu-item-1016"><a href="https://wp.nkdev.info/squadforce/blocks/testimonial/">Testimonial</a>
										</li>
										<li id="menu-item-1006" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--2__item ghost_menu__item--1006 menu-item-1006"><a href="https://wp.nkdev.info/squadforce/blocks/divider/">Divider</a>
										</li>
										<li id="menu-item-1007" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--2__item ghost_menu__item--1007 menu-item-1007"><a href="https://wp.nkdev.info/squadforce/blocks/google-maps/">Google Maps</a>
										</li>
										<li id="menu-item-1010" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--2__item ghost_menu__item--1010 menu-item-1010"><a href="https://wp.nkdev.info/squadforce/blocks/instagram/">Instagram</a>
										</li>
										<li id="menu-item-1017" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--2__item ghost_menu__item--1017 menu-item-1017"><a href="https://wp.nkdev.info/squadforce/blocks/twitter/">Twitter</a>
										</li>
									</ul>
								</li>
								<li id="menu-item-454" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--1__item ghost_menu__item--454 menu-item-454"><a href="https://wp.nkdev.info/squadforce/widgets/">Widgets</a>
								</li>
								<li id="menu-item-955" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--1__item ghost_menu__item--955 menu-item-955"><a href="https://wp.nkdev.info/squadforce/content-formatting/">Content Formatting</a>
								</li>
								<li id="menu-item-1001" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--1__item ghost_menu__item--1001 menu-item-1001"><a href="https://wp.nkdev.info/squadforce/animate-on-scroll/">Animate on Scroll</a>
								</li>
								<li id="menu-item-967" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--1__item ghost_menu__item--967 menu-item-967"><a href="https://wp.nkdev.info/squadforce/forms/">Forms</a>
								</li>
								<li id="menu-item-374" class="menu-item menu-item-type-post_type_archive menu-item-object-forum menu-item-has-children nk-drop-item ghost_menu__sub-menu__item ghost_menu__sub-menu--1__item ghost_menu__item--374 menu-item-374"><a href="https://wp.nkdev.info/squadforce/forums/">bbPress Forums</a>
									<ul class="dropdown sub-menu">
										<li id="menu-item-1020" class="menu-item menu-item-type-post_type_archive menu-item-object-forum ghost_menu__sub-menu__item ghost_menu__sub-menu--2__item ghost_menu__item--1020 menu-item-1020"><a href="https://wp.nkdev.info/squadforce/forums/">Forums</a>
										</li>
										<li id="menu-item-375" class="menu-item menu-item-type-post_type menu-item-object-forum ghost_menu__sub-menu__item ghost_menu__sub-menu--2__item ghost_menu__item--375 menu-item-375"><a href="https://wp.nkdev.info/squadforce/forums/forum/main-game-discussions/">Topics</a>
										</li>
										<li id="menu-item-873" class="menu-item menu-item-type-custom menu-item-object-custom ghost_menu__sub-menu__item ghost_menu__sub-menu--2__item ghost_menu__item--873 menu-item-873"><a href="https://wp.nkdev.info/squadforce/forums/topic/suggestion/">Single Topic</a>
										</li>
									</ul>
								</li>
								<li id="menu-item-455" class="menu-item menu-item-type-custom menu-item-object-custom ghost_menu__sub-menu__item ghost_menu__sub-menu--1__item ghost_menu__item--455 menu-item-455"><a href="https://wp.nkdev.info/squadforce/404">404 Page</a>
								</li>
							</ul>
						</li>
						<li id="menu-item-239" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children ghost_menu__item nk-drop-item ghost_menu__item--239 menu-item-239"><a href="https://wp.nkdev.info/squadforce/blog-grid/">Blog</a>
							<ul class="dropdown sub-menu">
								<li id="menu-item-243" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--1__item ghost_menu__item--243 menu-item-243"><a href="https://wp.nkdev.info/squadforce/news/">News</a>
								</li>
						...
						<li id="menu-item-443" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children ghost_menu__item nk-drop-item ghost_menu__item--443 menu-item-443"><a href="https://wp.nkdev.info/squadforce/shop/">Shop</a>
							<ul class="dropdown sub-menu">
								<li id="menu-item-560" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--1__item ghost_menu__item--560 menu-item-560"><a href="https://wp.nkdev.info/squadforce/store/">Store</a>
								</li>
								<li id="menu-item-444" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--1__item ghost_menu__item--444 menu-item-444"><a href="https://wp.nkdev.info/squadforce/shop/">Catalog</a>
								</li>
								<li id="menu-item-445" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--1__item ghost_menu__item--445 menu-item-445"><a href="https://wp.nkdev.info/squadforce/action-games/">Catalog alt</a>
								</li>
								<li id="menu-item-446" class="menu-item menu-item-type-post_type menu-item-object-product ghost_menu__sub-menu__item ghost_menu__sub-menu--1__item ghost_menu__item--446 menu-item-446"><a href="https://wp.nkdev.info/squadforce/product/just-then-her-head/">Product</a>
								</li>
								<li id="menu-item-448" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--1__item ghost_menu__item--448 menu-item-448"><a href="https://wp.nkdev.info/squadforce/checkout/">Checkout</a>
								</li>
								<li id="menu-item-449" class="menu-item menu-item-type-post_type menu-item-object-page ghost_menu__sub-menu__item ghost_menu__sub-menu--1__item ghost_menu__item--449 menu-item-449"><a href="https://wp.nkdev.info/squadforce/cart/">Cart</a>
								</li>
							</ul>
						</li> -->
					...
					<ul class="nk-nav nk-nav-right nk-nav-icons">
						<li class="single-icon d-lg-none">
							<a href="#" class="no-link-effect" data-nav-toggle="#nk-nav-mobile"> <span class="nk-icon-burger"> <span class="nk-t-1"></span>  <span class="nk-t-2"></span>  <span class="nk-t-3"></span> </span>
							</a>
						</li>
					</ul>
				</div>
	...
	<div id="nk-nav-mobile" class="nk-navbar nk-navbar-side d-lg-none nk-navbar-right-side nk-navbar-overlay-content">
		<div class="nano">
			<div class="nano-content">
				<a href="https://wp.nkdev.info/squadforce/" class="nk-nav-logo">
					<img src="https://wp.nkdev.info/squadforce/wp-content/themes/squadforce/assets/images/logo.svg" style="width: 120px; height: auto;" alt="" />
				</a>
						...
						<div class="col-lg-12">
							<article id="post-12" class="post-12 page type-page status-publish hentry">
								<div class="entry-content">
										...
										<div class="ghostkit-grid-inner">
											<div class="ghostkit-col ghostkit-col-lg-12 ghostkit-col-4">
												<div class="ghostkit-col-content">
													<div class="ghostkit-icon-box ghostkit-custom-Z1caIr8">

														<div class="ghostkit-icon-box-content">
															<h3 class="nk-feature-title ghostkit-custom-Z1TdVt6" STYLE="TEXT-ALIGN: CENTER;">MOBILE GAMES</h3>
														</div>
													</div>
												</div>
											</div>
											<div class="ghostkit-col ghostkit-col-lg-12 ghostkit-col-4">
												<div class="ghostkit-col-content">
													<div class="ghostkit-icon-box ghostkit-custom-Z11HzSx">

														<div class="ghostkit-icon-box-content">
															<h3 class="nk-feature-title ghostkit-custom-Z2ivI4T" STYLE="TEXT-ALIGN: CENTER;">UI/UIX</h3>
														</div>
													</div>
												</div>
											</div>
											<div class="ghostkit-col ghostkit-col-lg-12 ghostkit-col-4">
												<div class="ghostkit-col-content">
													<div class="ghostkit-icon-box ghostkit-custom-Z11HzSx">
														...
														<div class="ghostkit-icon-box-content">
															<h3 class="nk-feature-title ghostkit-custom-Z2ivI4T" STYLE="TEXT-ALIGN: CENTER;">OTHER SERVICES</h3>
														</div>
													</div>
												</div>
											</div>
									...
									<h3 class="is-style-squadforce-decorated ghostkit-custom-1IOFOw"><span style="color:#dd163b" class="has-inline-color">who</span> &nbsp;&nbsp;  WE ARE ?</h3>
	...
	<footer class="nk-footer">
		<div class="container">
			...
			<div class="row vertical-gap">
				<div class="col-md-6">
					<div id="ghostkit_reusable_widget-18" class="nk-widget ghostkit-reusable-widget">
						<h4 class="nk-widget-title"><span>Contact With Us</span></h4>
						<div class="ghostkit-form" id="gkt_form_fe8826db">
							<form method="POST" name="ghostkit-form" action="/squadforce/#gkt_form_fe8826db">
								<div class="ghostkit-form-field ghostkit-form-field-email">
									<label class="ghostkit-form-field-label ghostkit-form-field-label-hidden" for="gkt_form_fe8826db_field_email">Email<span class="required">*</span>
									</label>
								...
								<div class="ghostkit-form-field ghostkit-form-field-textarea">
									<label class="ghostkit-form-field-label ghostkit-form-field-label-hidden" for="gkt_form_fe8826db_field_message">Message<span class="required">*</span>
									</label>
				...
				<div class="col-md-6">
					<div id="ghostkit_reusable_widget-8" class="nk-widget ghostkit-reusable-widget">
						...
						<div class="wp-block-nk-visual-portfolio ghostkit-custom-25cq94">
							<div class="vp-portfolio vp-uid-17f1321e vp-id-117 ghostkit-custom-25cq94" data-vp-layout="masonry" data-vp-items-style="squadforce-list" data-vp-items-click-action="url" data-vp-items-gap="15" data-vp-pagination="load-more" data-vp-next-page-url="https://wp.nkdev.info/squadforce/?vp_page=2" data-vp-masonry-columns="2">
								<div class="vp-portfolio__preloader-wrap">
									<div class="vp-portfolio__preloader"><span></span><span></span><span></span><span></span><i></i>
									</div>
								</div>
								<div class="vp-portfolio__items-wrap">
									<div class="vp-portfolio__items vp-portfolio__items-style-squadforce-list">
										<article class="vp-portfolio__item-wrap post-159 post type-post status-publish format-standard has-post-thumbnail hentry category-strategy" data-vp-filter="strategy">
											<figure class="vp-portfolio__item">
												<div class="nk-blog-post nk-post-widget">
													<div class="row vertical-gap">
														<div class="col-lg-4">
															<a href="https://wp.nkdev.info/squadforce/for-good-too-though-in-consequence/" class="nk-post-img nk-widget-img">
																<img width="970" height="545" src="data:image/svg+xml,%3csvg width=&#039;194&#039; height=&#039;109&#039; viewBox=&#039;0 0 194 109&#039; fill=&#039;none&#039; xmlns=&#039;http://www.w3.org/2000/svg&#039;%3e%3c/svg%3e" class="attachment-vp_xl size-vp_xl visual-portfolio-lazyload" alt="" data-no-lazy="1" data-vpf-src="https://wp.nkdev.info/squadforce/wp-content/uploads/2019/09/post-41.jpg" data-vpf-sizes="auto" data-vpf-srcset="https://wp.nkdev.info/squadforce/wp-content/uploads/2019/09/post-41.jpg 970w, https://wp.nkdev.info/squadforce/wp-content/uploads/2019/09/post-41-500x281.jpg 500w, https://wp.nkdev.info/squadforce/wp-content/uploads/2019/09/post-41-800x449.jpg 800w, https://wp.nkdev.info/squadforce/wp-content/uploads/2019/09/post-41-128x72.jpg 128w, https://wp.nkdev.info/squadforce/wp-content/uploads/2019/09/post-41-600x337.jpg 600w, https://wp.nkdev.info/squadforce/wp-content/uploads/2019/09/post-41-300x169.jpg 300w, https://wp.nkdev.info/squadforce/wp-content/uploads/2019/09/post-41-768x432.jpg 768w, https://wp.nkdev.info/squadforce/wp-content/uploads/2019/09/post-41-48x27.jpg 48w" />
															</a>
														</div>
														<div class="col-lg-8">
															<div class="nk-post-title"> <a href="https://wp.nkdev.info/squadforce/for-good-too-though-in-consequence/"> Lesser years third in you&#8217;re rule </a>
															</div>
															<div class="nk-post-date"> <span class="fa fa-calendar"></span>&nbsp;September 12, 2019</div>
														</div>
													</div>
												</div>
											</figure>
										</article>
										<article class="vp-portfolio__item-wrap post-162 post type-post status-publish format-standard has-post-thumbnail hentry category-racing" data-vp-filter="racing">
											<figure class="vp-portfolio__item">
												<div class="nk-blog-post nk-post-widget">
													<div class="row vertical-gap">
														<div class="col-lg-4">
															<a href="https://wp.nkdev.info/squadforce/we-found-a-witch-may-we-burn-her-2/" class="nk-post-img nk-widget-img">
																<img width="800" height="450" src="data:image/svg+xml,%3csvg width=&#039;16&#039; height=&#039;9&#039; viewBox=&#039;0 0 16 9&#039; fill=&#039;none&#039; xmlns=&#039;http://www.w3.org/2000/svg&#039;%3e%3c/svg%3e" class="attachment-vp_xl size-vp_xl visual-portfolio-lazyload" alt="" data-no-lazy="1" data-vpf-src="https://wp.nkdev.info/squadforce/wp-content/uploads/2019/09/post-31.jpg" data-vpf-sizes="auto" data-vpf-srcset="https://wp.nkdev.info/squadforce/wp-content/uploads/2019/09/post-31.jpg 800w, https://wp.nkdev.info/squadforce/wp-content/uploads/2019/09/post-31-500x281.jpg 500w, https://wp.nkdev.info/squadforce/wp-content/uploads/2019/09/post-31-128x72.jpg 128w, https://wp.nkdev.info/squadforce/wp-content/uploads/2019/09/post-31-600x338.jpg 600w, https://wp.nkdev.info/squadforce/wp-content/uploads/2019/09/post-31-300x169.jpg 300w, https://wp.nkdev.info/squadforce/wp-content/uploads/2019/09/post-31-768x432.jpg 768w, https://wp.nkdev.info/squadforce/wp-content/uploads/2019/09/post-31-48x27.jpg 48w" />
															</a>
														</div>
														<div class="col-lg-8">
															<div class="nk-post-title"> <a href="https://wp.nkdev.info/squadforce/we-found-a-witch-may-we-burn-her-2/"> We found a witch! May we burn her? </a>
															</div>
															<div class="nk-post-date"> <span class="fa fa-calendar"></span>&nbsp;September 6, 2019</div>
														</div>
													</div>
												</div>
											</figure>
					...
					<div id="ghostkit_reusable_widget-9" class="nk-widget ghostkit-reusable-widget">
						<h4 class="nk-widget-title"><span>In Twitter</span></h4>
						<div class="ghostkit-twitter ghostkit-custom-ZBInPn">
							<div class="ghostkit-twitter-items">
								<div class="ghostkit-twitter-item">
									<div class="ghostkit-twitter-item-content">
										...
										<div class="ghostkit-twitter-item-text">Custom icons for your lists easily with Ghost Kit and <a href="https://twitter.com/hashtag/gutenberg" target="_blank">#gutenberg</a>  <a href="https://twitter.com/hashtag/wordpress" target="_blank">#wordpress</a> in the next plugin update… <a href="https://t.co/VhI5I7Zm7O" target="_blank">twitter.com/i/web/status/1…</a>
										</div>
									</div>
								</div>
							</div>
		...
		<div class="nk-copyright">
			<div class="container">
				<div class="nk-copyright-left">
					<p class="mb-0">Copyright © 2020 <a href="https://themeforest.net/user/_nk?ref=_nK" target="_blank" rel="noopener">nK</a>
					</p>
				</div>
	...
	<img class="nk-page-background-top" src="https://wp.nkdev.info/squadforce/wp-content/uploads/2019/11/bg-top.png" alt="Top Background Image">
	<img class="nk-page-background-bottom" src="https://wp.nkdev.info/squadforce/wp-content/uploads/2019/11/bg-bottom.png" alt="Bottom Background Image">
	<div class="nk-modal modal fade" id="modalSearch" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				<div class="modal-body">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span class="ion-android-close"></span>
					</button>
					<h4 class="mb-0">Search</h4>
					<div class="nk-gap-1"></div>
					<form action="https://wp.nkdev.info/squadforce/" class="nk-form nk-form-style-1">
		...
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				<div class="modal-body">
					...
					<div class="nk-sign-form-container lwa lwa-default">
						<form class="nk-sign-form-login active lwa-form nk-form text-white" action="https://wp.nkdev.info/squadforce/wp-login.php" method="post">
							<div>
								<h4 class="mb-0"><span class="text-main-1">Sign</span>&nbsp;In</h4>
								<div class="nk-gap-1"></div> <span class="lwa-status"></span>  <span class="lwa-username"> <span class="lwa-username-input"> <input class="form-control" type="text" placeholder="Username or Email" name="log"> </span> </span>
								<div class="nk-gap"></div> <span class="lwa-password"> <span class="lwa-password-input"> <input class="form-control" type="password" placeholder="Password" name="pwd"> </span> </span>
								<div class="nk-gap"></div>
								<div class="row vertical-gap">
									<div class="lwa-submit col-md-6">
										<div class="form-row align-items-center">
											<div class="col-auto">
												<div class="custom-control custom-checkbox float-left mr-sm-2">
													...
													<label class="custom-control-label" for="remembermeLwa">Remember Me</label>
												</div>
											</div>
											<div class="col lwa-submit-button">
												<button class="nk-btn nk-btn-rounded nk-btn-color-white nk-btn-block" name="wp-submit" id="lwa_wp-submit" value="Sign In">Sign In</button>
									...
									<div class="col-md-6">
										<div> <a class="nk-sign-form-lost-toggle" href="#">Forgot your password?</a>
										</div>
									</div>
								</div>
						...
						<form class="nk-sign-form-lost lwa-remember" action="https://wp.nkdev.info/squadforce/wp-login.php?action=lostpassword" method="post">
							<div>
								<h4 class="mb-0"><span class="text-main-1">Lost</span>&nbsp;Password</h4>
								<div class="nk-gap-1"></div> <span class="lwa-status"></span>  <span class="lwa-remember-email"> <input type="text" name="user_login" class="form-control lwa-user-remember" value="Enter username or email" onfocus="if(this.value == 'Enter username or email'){this.value = '';}" onblur="if(this.value == ''){this.value = 'Enter username or email'}" /> </span>
								<div class="nk-gap"></div> <span class="lwa-remember-buttons"> <button class="nk-btn nk-btn-rounded nk-btn-color-white text-dark-1 float-right lwa-button-remember">Get New Password</button> <input type="hidden" name="login-with-ajax" value="remember" /> </span>  <a class="nk-sign-form-login-toggle float-left" href="#">Back to Log In</a>
								<div class="clearfix"></div>
							</div>
						</form>
					</div>
